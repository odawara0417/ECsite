...
import com.internousdev.kamaboko.util.InputChecker;
...
public class CreateUserConfirmAction extends ActionSupport implements SessionAware {
	...
	public String execute(){
		...
		familyNameKanaErrorMessageList=inputChecker.docheck("姓ふりがな",familyNameKana,1, 16, true, true, true, false, false, false, false);
		firstNameKanaErrorMessageList=inputChecker.docheck("名ふりがな",firstNameKana,1, 16, true, true, true, false, false, false, false);
		emailErrorMessageList=inputChecker.docheck("メールアドレス",email,14, 32, true, true, true, false, false, false, false);
		loginIdErrorMessageList=inputChecker.docheck("ログインID",loginId,1, 8, true, true, true, false, false, false, false);
		passwordErrorMessageList=inputChecker.docheck("パスワード",password,1, 16, true, true, true, false, false, false, false);
