...
//		フォームの入力内容をInputCheckerを用いてチェックする
	    ...
	    emailErrorMessageList=inputChecker.docheck("メールアドレス",email,18, 32, true, false, false, false, false, false, false);

//	    もし各項目のエラーがすべて０であるならばSUCCESSを返す
...
//	    そうでなければ対応するsessionにエラーメッセージを格納
	    else{
