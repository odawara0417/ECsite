...
<s:if test="#session.checkLisrErrorMessageList!=null">
<div class="error">
...
<s:if test="#session.cartInfoDto.size()>0">
<s:form id="form" action="SettlementConfirmAction">
<table class="horizontal-list-table">
<thead>
<tr>
<td><s:label value="#"/></td>
<td><s:label value="商品名"/></td>
<td><s:label value="ふりがな"/></td>
<td><s:label value="商品画像"/></td>
<td><s:label value="値段"/></td>
<td><s:label value="発売会社名"/></td>
<td><s:label value="発売年月日"/></td>
<td><s:label value="購入個数"/></td>
<td><s:label value="合計金額"/></td>
</tr>
</thead>
<tbody>
<s:iterator value="session:if ion.cartInfoDtolist">
<tr>
...
<h2><s:label value="カート合計情報:"/><s:property value="#session.totalPrice"/>円</h2><br>
<div class="submit_btn_box">
<div class=".contants_btn_set">
